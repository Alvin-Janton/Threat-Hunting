...
Output of `enrich_s3_events.py` — the fully cleaned and investigation-ready dataset.
...
- **[ec2_proxy_s3_exfiltration_2020-09-14011940.jsonl](./ec2_proxy_s3_exfiltration/ec2_proxy_s3_exfiltration_2020-09-14011940.jsonl)**  
  CloudTrail JSON Lines log containing the adversary’s EC2 → S3 exfiltration activity.
...
- **[search_userAgent.jsonl](./extended_search/search_userAgent.jsonl)**  
  Events tied to the attacker’s userAgent string:  
